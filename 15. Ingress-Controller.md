...
### Enable mTLS :
Enable mTLS for namespace: `mtls-permissive.yaml`
```
apiVersion: security.istio.io/v1beta1
kind: PeerAuthentication
metadata:
...
Once everything is stable you can move to STRICT:
```
apiVersion: security.istio.io/v1beta1
kind: PeerAuthentication
metadata:
...
### Add DestinationRule (important)

This tells clients to use mTLS:
```
apiVersion: networking.istio.io/v1beta1
